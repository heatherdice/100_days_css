...
// extract generation logic into reusable function
function generateIndex() {
    const files = fs.readdirSync(componentsDir).filter(file => file.startsWith('Day') && file.endsWith('.js') && file !== 'index.js');
